...
const Checkout = (props) => {
  return (
    <section className='min-h-[85vh] w-full p-24 flex justify-center gap-12 items-start'>
      ...
      <div className={`w-1/4 h-it p-8 pb-16 flex flex-col items-center justify-center dark:bg-neutral-700 bg-slate-300`}>
        ...
        <button className={`p-4 text-sm font-bold dark:bg-slate-200 dark:text-black bg-neutral-800 text-white`}>FINALIZAR COMPRA</button>
      </div>
